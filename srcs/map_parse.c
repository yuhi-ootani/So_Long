...
/*   Updated: 2025/01/16 08:15:18 by oyuhi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_map(char *file, t_map *map)
{
	...
	if ((map->height >= 0 && map->height <= 2) || (map->height == -2))
	...
	map->width = ft_strlen_newline(map->grid[0]);
	if (map->width == -1)
...
// {
// 	t_map	valid_map = {.grid = (char *[]){"11111", "1P0C1", "", "1C0E1",
// 			"11111", NULL}, .width = 5, .height = 5, .collectibles = 0,
// 			.exits = 0, .players = 0};
// 	t_map	non_rectangular_map = {.grid = (char *[]){"11111", "1P0C1", "10001",
// 			"1C0E", "11111", NULL}, .width = 5, .height = 5};
// 	t_map	not_surrounded_by_walls = {.grid = (char *[]){"11111", "1P0C1",
// 			"10001", "1C0E0", "11110", NULL}, .width = 5, .height = 5};
// 	t_map	missing_elements = {.grid = (char *[]){"11111", "1P001", "10001",
// 			"10001", "11111", NULL}, .width = 5, .height = 5};
// 	t_map	no_valid_path = {.grid = (char *[]){"11111", "1P001", "11101",
// 			"1C0E1", "11111", NULL}, .width = 5, .height = 5};
...
// 	{
// 		printf("Test 3 Passed: Map not surrounded correctly identified\n");
// 	}
// 	else
// 	{
...
// 	{
// 		printf("Test4 Passed: missing elements correctly identified\n");
// 	}
// 	else
// 	{
